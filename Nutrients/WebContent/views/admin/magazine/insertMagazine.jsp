...
<script type="text/javascript" src="../../../resource/js/smartEditor/js/service/HuskyEZCreator.js"></script>
       ...
       <div class="content">
           <div class="content_title">
                ...
                <!-- 파일을 서블릿으로 전달하려면 반드시 enctype="multipart/form-data" 속성을 작성해주어야 함-->
                    <form id="enroll-form" action="/na/insert.mg" method="post" enctype="multipart/form-data">

                        <div id="magazine_title">
                        <input type="text" name="title" placeholder="제목을 입력하세요" required>
                        </div>
                        <div id="magazine_content">
                            <textarea id="mgContent" name="content" placeholder="내용을 입력하세요" required></textarea>
                        </div>
                        <div id="mag_photo">
		...
		    oAppRef: oEditors,
		    elPlaceHolder: "mgContent",  //textarea ID
